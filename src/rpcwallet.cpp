...
Value setaccount(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\", \"tabby\"")
        );
...
Value getaccount(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\"")
            + HelpExampleRpc("getaccount", "\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\"")
        );
...
Value sendtoaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleRpc("sendtoaddress", "\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\", 0.1, \"donation\", \"seans outpost\"")
        );
...
Value signmessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            + HelpExampleCli("signmessage", "\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\", \"my message\"")
        );
...
Value getreceivedbyaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n"
            + HelpExampleCli("getreceivedbyaddress", "\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\", 6")
       );
...
Value sendfrom(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 3 || params.size() > 6)
        throw runtime_error(
            ...
            + HelpExampleCli("sendfrom", "\"tabby\" \"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\" 0.01 6 \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\", 0.01, 6, \"donation\", \"seans outpost\"")
        );
...
Value sendmany(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\\\":0.01,\\\"HNAWWinbaP4RornDJAmVKDFSBVEFZ5pnmq\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\\\":0.01,\\\"HNAWWinbaP4RornDJAmVKDFSBVEFZ5pnmq\\\":0.02}\" 6 \"testing\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\\\":0.01,\\\"HNAWWinbaP4RornDJAmVKDFSBVEFZ5pnmq\\\":0.02}\", 6, \"testing\"")
        );
...
Value addmultisigaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
    {
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            + HelpExampleCli("addmultisigaddress", "2 \"[\\\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\\\",\\\"HNAWWinbaP4RornDJAmVKDFSBVEFZ5pnmq\\\"]\"") +
            "\nAs json rpc call\n"
            + HelpExampleRpc("addmultisigaddress", "2, \"[\\\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\\\",\\\"HNAWWinbaP4RornDJAmVKDFSBVEFZ5pnmq\\\"]\"")
        ;
...
Value listsinceblock(const Array& params, bool fHelp)
{
    if (fHelp)
        throw runtime_error(
            ...
            + HelpExampleCli("listsinceblock", "\"a31a9a03d44c3214699942510414b3b61ff01afdd6ee4e78a559d76194ff5f8f\" 6")
            + HelpExampleRpc("listsinceblock", "\"a31a9a03d44c3214699942510414b3b61ff01afdd6ee4e78a559d76194ff5f8f\", 6")
        );
...
Value gettransaction(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("gettransaction", "\"7841777d7f52596403ff2a9b7b58e6b78d77ae0df9a85ba128deb1edc047607d\"")
            + HelpExampleCli("gettransaction", "\"7841777d7f52596403ff2a9b7b58e6b78d77ae0df9a85ba128deb1edc047607d\" true")
            + HelpExampleRpc("gettransaction", "\"7841777d7f52596403ff2a9b7b58e6b78d77ae0df9a85ba128deb1edc047607d\"")
        );
...
Value walletlock(const Array& params, bool fHelp)
{
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 0))
        throw runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\" 1.0") +
