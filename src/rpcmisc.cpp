...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\"")
            + HelpExampleRpc("validateaddress", "\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\"")
        );
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            + HelpExampleCli("createmultisig", "2 \"[\\\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\\\",\\\"HNAWWinbaP4RornDJAmVKDFSBVEFZ5pnmq\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("createmultisig", "2, \"[\\\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\\\",\\\"HNAWWinbaP4RornDJAmVKDFSBVEFZ5pnmq\\\"]\"")
        ;
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"HJD4YANVjJFC2bXQraFwPHodBa8zSeduAm\", \"signature\", \"my message\"")
        );
