...
Output from `gbuild` will look something like
    ...
    From https://github.com/hypercoin-project/hypercoin
...
[hypercoin/gitian.sigs](https://github.com/hypercoin-project/gitian.sigs.hot/) repository, or if that's not possible create a pull
request. 
